"""Guide TTS for kiosk prompts — Cartesia Kabir, with OpenAI fallback.

Re-exports shared TTS implementation from backend/services/tts_service.
"""
...
# Add backend directory to sys.path if running from bot/ root
...
try:
    from services.tts_service import (
        ...
        OPENAI_TTS_VOICE,
        cartesia_language,
        synthesize_guide_mp3,
    )
except ImportError:
    # Standalone implementation if running without backend directory on path
    import os
...
__all__ = ["synthesize_guide_mp3", "cartesia_language"]
